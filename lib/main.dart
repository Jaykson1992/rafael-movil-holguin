  ...
  @override Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.all(24), children: [
        ...
        const Text('Si ya tienes cuenta, entra con tu carnet y PIN. Si eres nuevo, crea tu cuenta.'),
